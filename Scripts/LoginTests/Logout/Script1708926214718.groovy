...
WebUI.setText(findTestObject('Object Repository/Page_ParaBank  Welcome  Online Banking/input_Username_username'), 'lagitest')
...
WebUI.verifyElementPresent(findTestObject('Object Repository/Page_ParaBank  Accounts Overview/a_Log Out'), 0)
